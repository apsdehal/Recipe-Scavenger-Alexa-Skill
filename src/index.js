...
var welcomeMessage = "Welcome to Scavenger. I can tell you recipes based on what you have, or I can tell you what is popular nearby. What will it be?";
...
var recommendations = "These are the " + numberOfResults + " recipes based on the ingredients you provided, you can read more on your Alexa app. ";
...
var newSessionHandlers = {
    ...
    'finishRecommendationsIntent': function () {
        this.handler.state = states.SEARCHMODE;
        this.emitWithState('finishRecommendationsIntent');
    },
    ...
    'getInfoForRecommendations': function () {
        ...
        if(this.event.request.intent.slots.ingredient) {
            if (this.event.request.intent.slots.ingredient.value) {
                slotValue = this.event.request.intent.slots.ingredient.value;
                this.attributes.ingredients = this.attributes.ingredients || [];
                this.attributes.ingredients.push(slotValue);
            }
            this.emit(':ask', 'Do you have any more', tryAgainMessage);
        } else {
            ...
            if (responseData == null) {
                ...
                for (var i = 0; i < responseData.results.length; i++) {
                    ...
                    if (i < numberOfResults) {
                        ...
                        output += " Recommendation " + index + ": " + headline + ";";
